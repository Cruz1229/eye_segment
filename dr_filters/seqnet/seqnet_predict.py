...
import sys
sys.path.append('dr_filters\seqnet')
...
def predict(ACTIVATION='ReLU', dropout=0.1, batch_size=32, repeat=4, minimum_kernel=32,
    ...
    print(f"Model :", config_file["seqnet"]["model"])
    #load_path = f"trained_model/{DATASET}/{model_name}.hdf5"
    load_path = config_file["seqnet"]["model"]
...
if __name__ == "__main__":
    ...
    output_path = args.output if args.output else config_file["seqnet"]["output"]
